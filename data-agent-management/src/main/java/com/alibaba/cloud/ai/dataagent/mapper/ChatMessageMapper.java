...
public interface ChatMessageMapper {
	 ...
	 */
	@Select("""
			SELECT COUNT(*) FROM saad_chat_message
			WHERE session_id = #{sessionId}
			""")
	...
	@Insert("""
			INSERT INTO saad_chat_message (session_id, role, content, message_type, metadata, create_time)
