...
-- 业务知识示例数据
INSERT IGNORE INTO `saad_business_knowledge` (`id`, `business_term`, `description`, `synonyms`, `is_recall`, `agent_id`, `created_time`, `updated_time`) VALUES
...
-- 语义模型示例数据
INSERT IGNORE INTO `saad_semantic_model` (`id`, `agent_id`, `datasource_id`, `table_name`, `column_name`, `business_name`, `synonyms`, `business_description`, `column_comment`, `data_type`, `created_time`, `updated_time`, `status`) VALUES
...
-- 智能体示例数据
INSERT IGNORE INTO `saad_agent` (`id`, `name`, `description`, `avatar`, `status`, `api_key`, `api_key_enabled`, `prompt`, `category`, `admin_id`, `tags`, `create_time`, `update_time`) VALUES
...
-- 智能体知识示例数据
INSERT IGNORE INTO `saad_agent_knowledge` (`id`, `agent_id`, `title`, `content`, `type`, `is_recall`, `embedding_status`, `file_type`, `created_time`, `updated_time`) VALUES
...
-- 数据源示例数据
-- 示例数据源可以运行docker-compose-saad_datasource.yml建立，或者手动修改为自己的数据源
INSERT IGNORE INTO `saad_datasource` (`id`, `name`, `type`, `host`, `port`, `database_name`, `username`, `password`, `connection_url`, `status`, `test_status`, `description`, `creator_id`, `create_time`, `update_time`) VALUES
...
-- 智能体数据源关联示例数据
INSERT IGNORE INTO `saad_agent_datasource` (`id`, `agent_id`, `datasource_id`, `is_active`, `create_time`, `update_time`) VALUES
